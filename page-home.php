    ...
    <section id="about__section" class="about__section">
      ...
      <div class="about">
        ...
        <div class="about__me">
          ...
          <h2 class="about__me-heading" data-aos="fade-up" data-aos-duration="1500">Cześć, jestem Karolina!</h2>
          <p class="about__me-text" data-aos="fade-up"  data-aos-delay="200" data-aos-duration="1500">
            Certyfikowana trenerka personalna oraz instruktorka
            fitness. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laborum, eaque. Lorem ipsum dolor sit
            amet. Lorem ipsum dolor sit amet consectetur adipisicing elit. In, laborum.
          </p>

          <a href="#" class="about__me-button" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1500">Poznaj mnie</a>
        </div>
      </div>
      ...
      <div class="offer__section-container">
        ...
        <div class="offer__section-contact justify-content" data-aos="fade-up" data-aos-duration="1400">
          ...
          <p class="offer__section-text">
            Nie wiesz jak zacząć walkę o lepsze jutro i zdrowe ciało? Skontaktuj się ze mną, chętnie Ci pomogę. Lorem
            ipsum, dolor sit amet consectetur adipisicing elit. Eum, est? adipisicing elit.
          </p>
        ...
        <div class="offer__section-shop justify-content" data-aos="fade-up" data-aos-duration="1400">
          ...
          <p class="offer__section-text">Zapraszam Cię na indywidualny trening. W swoich treningach stawiam na poprawną
            technikę oraz odpowiedni oddech.
            Razem wypracujemy świetne efekty i osiągniemy twój cel!
          </p>
          <a href="" class="offer__section-link-shop section-btn">Zobacz ofertę <i class="fas fa-shopping-cart"></i></a>
        </div>
...
<div class="motto__section-container">
  ...
  <h3 class="motto__section-heading">Moving well to feel good...</h3>
  <p class="motto__section-subtitle">
    ...
    <section class="opinion__section">
      ...
      <div class="opinion__section-container carousel">
        ...
        <div class="opinion__section-box">
          <div class="opinion__section-box-photo"><img class="opinion__section-box-img" src="<?php echo get_theme_file_uri('/img/ZosiaK.jpg') ?>" alt="Zdjęcie podopiecznej Zosi K."></div>
      ...
      <div class="blog__list">
        ...
        <div class="blog__item">
          ...
          <p class="blog__item-text">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est voluptas delectus qui eaque enim inventore dolor, ut aperiam fugit nisi.
            qu.
          </p>
          <a href="" class="blog__item-link link-one">Moje ćwiczenia</a>
        </div>
        ...
        <div class="blog__item">
          ...
          <p class="blog__item-text">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit id dolorem expedita asperiores est, magni atque dolores! At, odit autem?
          </p>
          <a href="" class="blog__item-link link-two">Moje posiłki</a>
        </div>
        ...
        <div class="blog__item">
          ...
          <p class="blog__item-text">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis sapiente laborum, error nam voluptates voluptatum ipsum in quidem aut eius.
          </p>
          <a href="" class="blog__item-link link-three">Motywacja</a>
        </div>
